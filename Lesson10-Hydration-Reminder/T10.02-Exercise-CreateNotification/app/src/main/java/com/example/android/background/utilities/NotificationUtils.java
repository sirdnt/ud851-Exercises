...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 134;
    private static final int WATER_REMINDER_NOTIFICATION_ID = 977;
    private static final String WATER_REMINDER_NOTIFICATION_CHANNGEL_ID = "reminder_notification_channel";
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel mChannel = new NotificationChannel(
                    WATER_REMINDER_NOTIFICATION_CHANNGEL_ID,
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context, WATER_REMINDER_NOTIFICATION_CHANNGEL_ID)
