...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 775;

    private static final int ACTION_DRINK_PENDING_INTENT_ID = 466;
    ...
    static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent incrementWaterPendingIntent = PendingIntent.getService(context, ACTION_DRINK_PENDING_INTENT_ID,drinkWaterIntent,PendingIntent.FLAG_UPDATE_CURRENT);
        //      DONE (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action drinkAction = new NotificationCompat.Action(R.drawable.ic_drink_notification,"I did it!",incrementWaterPendingIntent);
