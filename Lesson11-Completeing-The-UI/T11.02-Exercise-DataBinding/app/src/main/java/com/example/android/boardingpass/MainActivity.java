...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long minutes = minutesUntilBoarding - TimeUnit.HOURS.toMinutes(hours);
        String hoursToBeDisplay = getString(R.string.countDownFormat, hours, minutes);
        mBinding.textViewBoardingInCountdown.setText(hoursToBeDisplay);
    }
}
